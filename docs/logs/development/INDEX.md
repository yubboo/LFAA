...
| #21 | Web 工作台 UI | #21.15 | active | Web、容器响应式、Dock、Overlay、Header、Tooltip、吸附收起、布局变量、终端、PTY、ChatGPT、Codex | `active/0021-Web工作台UI.md` |
...
| #21.12 | superseded | `archive/0021-12-ShellTooltip单一提示源.md` |
