...
export default defineConfig({
  root: appRoot,
  plugins: [lfaaDevResourceBridge(), lfaaDevTerminalBridge(), lfaaDevAiConfigBridge(projectRoot), lfaaDevPluginManagerBridge(projectRoot), lfaaDevAgentRuntimeBridge(projectRoot)],
  server: {
    host: "127.0.0.1",
