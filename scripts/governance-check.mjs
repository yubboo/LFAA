...
const required = [
  ...
  "scripts/cargo-lock-consistency-check.mjs",
  ...
  "test/cargo-lock-consistency.test.mjs",
  ...
  "pnpm-lock.yaml",
  "pnpm-workspace.yaml",
  "scripts/package-architecture-check.mjs",
  "scripts/tsconfig-reference-check.mjs",
  "test/tsconfig-reference.test.mjs",
  "tsconfig.base.client.json",
  "scripts/current-fact-check.mjs",
