...
const runtimeControl=read("packages/app-shell/src/workbench/center/composer/runtime-control/view/RuntimeControl.tsx");
...
const permissionControl=read("packages/app-shell/src/workbench/center/composer/view/PermissionControl.tsx");
