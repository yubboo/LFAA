...
const root=read("packages/client/app-shell/src/AgentWorkbench.tsx");
const left=read("packages/client/app-shell/src/workbench/left/view/LeftSidebarRegion.tsx");
const profile=read("packages/client/app-shell/src/workbench/left/view/ProfileBar.tsx");
const overlays=read("packages/client/app-shell/src/workbench/shell/view/WorkbenchOverlays.tsx");
const overlaysCss=read("packages/client/app-shell/src/workbench/shell/styles/WorkbenchOverlays.module.css");
const themeController=read("packages/client/app-shell/src/workbench/shell/logic/useWorkbenchThemeController.ts");
const chromeController=read("packages/client/app-shell/src/workbench/shell/logic/useWorkbenchChromeController.ts");
const shellView=read("packages/client/app-shell/src/workbench/shell/view/WorkbenchShell.tsx");
const settingsSurface=read("packages/client/app-shell/src/workbench/settings/view/SettingsSurface.tsx");
const aiController=read("packages/client/app-shell/src/workbench/settings/logic/useAiSettingsController.ts");
const aiMappings=read("packages/client/app-shell/src/workbench/settings/logic/settings-view-models.ts");
const settings=read("packages/client/app-shell/src/workbench/settings/view/SettingsPage.tsx");
const aiPanel=read("packages/client/ui/src/features/settings/ai/AiSettingsPanel.tsx");
const themeMenu=read("packages/client/ui/src/features/appearance/ThemeModeMenu.tsx");
const settingsCss=read("packages/client/app-shell/src/workbench/settings/styles/settings.css");
const workbenchTypes=read("packages/client/ui/src/workbench/workbench-layout.types.ts");
