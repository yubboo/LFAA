...
`packages/ui` **不是 LFAA 所有产品页面的目录**。它提供跨产品模块复用的界面积木和交互算法；具体 Chat/Work 工作模式归 `@lfaa/workspace`；Shell、Left/Right、Composer、RuntimeControl、Settings 等产品外壳归 `@lfaa/app-shell`。
