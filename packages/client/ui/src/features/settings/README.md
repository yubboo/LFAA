...
本目录只保留 AI 配置图形面板及旧公开名称兼容包装；Settings 导航与 Plugin 管理页归 `packages/client/app-shell/src/workbench/settings/`。业务真值来自 `packages/settings/config-system` 的公开能力，UI 不复制配置逻辑。
