...
import type { ActiveReasoningControl, ChatProjectionMessage, LayoutMode, QuickModelOption } from "../contracts";
  ...
  return (
    <section className={styles.root} data-agent-surface={props.agentSurface} data-ui="center-workspace">
      ...
      <ConversationRegion
        ...
        workNodes={props.workNodes}
        onWorkNodesChange={props.onWorkNodesChange}
      />
      <ComposerRegion
        layoutMode={props.layoutMode}
        agentSurface={props.agentSurface}
