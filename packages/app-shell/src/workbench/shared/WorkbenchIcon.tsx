/**
 * 文件：workbench/shared/WorkbenchIcon.tsx
 ...
 * 关联文件：workbench/shared/index.ts 与各 Workbench UI 模块。
...
const paths: Record<WorkbenchIconName, ReactElement> = {
  ...
  refresh: <><path d="M20 7v5h-5"/><path d="M4 17v-5h5"/><path d="M6.1 8A7 7 0 0 1 18.5 6.5L20 9"/><path d="M17.9 16A7 7 0 0 1 5.5 17.5L4 15"/></>,
